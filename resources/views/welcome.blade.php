                    ...
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="#"><img src="{{('public/frontend/images/banner-sach-moi.jpg')}}" class="img-fluid"
                                        style="height: 386px;" width="900px" alt="First slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="{{('public/frontend/images/banner-beethoven.jpg')}}" class="img-fluid"
                                        style="height: 386px;" width="900px" alt="Second slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="{{('public/frontend/images/neu-toi-biet-duoc-khi-20-full-banner.jpg')}}" class="img-fluid"
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        <img src="{{('public/frontend/images/icon-books.png')}}" alt="icon-books">
                        <div class="noidung">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        <img src="{{('public/frontend/images/icon-gift.png')}}" alt="icon-gift">
                        <div class="noidung">
